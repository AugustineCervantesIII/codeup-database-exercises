...
SELECT CONCAT(first_name, ' ', last_name) AS Full_Name, CONCAT(birth_date) AS 'DOB' FROM employees LIMIT 10;
...
SELECT CONCAT(emp_no, ' - ', first_name, ' ', last_name) AS Full_Name, CONCAT(birth_date) AS 'DOB' FROM employees LIMIT 10;
